...
cfg = LanguageModelSAERunnerConfig(
    ...
    dataset_path="ckkissane/pile-chat-format-with-assistant-qwen1.5-0.5b-chat",  # this is a tokenized language dataset on Huggingface for the Tiny Stories corpus.
    ...
    l1_coefficient=3,  # will control how sparse the feature activations are
    l1_warm_up_steps=l1_warm_up_steps,  # this can help avoid too many dead features initially.
    lp_norm=1.0,  # the L1 penalty (and not a Lp for p < 1)
    train_batch_size_tokens=batch_size,
    context_size=2048,  # will control the length of the prompts we feed to the model. Larger is better but slower. so for the tutorial we'll use a short one.
    ...
    wandb_project="qwen-500M-chat-pile-inst-format-with-assistant",
    ...
    dtype="float32",
    # Performance optimizations # TODO: double check these
